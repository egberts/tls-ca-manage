...
function cmd_create_cert {
    ...
    create_generic_cert_req_config_file "$CNF_SECTION_REQ_EXT" "$CERT_OPENSSL_CNF_REQ_FILE"

    SECTION_CA="req_extension_${PARENT_IA_NAME}_${CA_TYPE}"
    ...
    cert_create_csr "$CNF_SECTION_REQ_EXT" \
