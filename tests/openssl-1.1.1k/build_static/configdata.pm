...
our %config = (
  ...
  ARFLAGS => [ "r" ],
  CC => "gcc",
  CFLAGS => [ "-g -O0 -ffile-prefix-map=/home/wolfe/work/github/tls-ca-manage/tests/openssl-1.1.1k=. -fstack-protector-strong -Wformat -Werror=format-security" ],
  CPPDEFINES => [  ],
  CPPFLAGS => [ "-Wdate-time" ],
  CPPINCLUDES => [  ],
  CXX => "g++",
  CXXFLAGS => [ "-g -O0 -ffile-prefix-map=/home/wolfe/work/github/tls-ca-manage/tests/openssl-1.1.1k=. -fstack-protector-strong -Wformat -Werror=format-security" ],
  ...
  minor => "1.1",
  openssl_algorithm_defines => [ "OPENSSL_NO_IDEA", "OPENSSL_NO_MD2", "OPENSSL_NO_MDC2", "OPENSSL_NO_RC5" ],
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_ASAN", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EGD", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_DYNAMIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "/usr/lib/ssl",
  options => "--prefix=/usr --openssldir=/usr/lib/ssl --libdir=lib/x86_64-linux-gnu enable-unit-test enable-rfc3779 enable-cms enable-ec_nistp_64_gcc_128 no-asan no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-dynamic-engine no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-idea no-md2 no-mdc2 no-msan no-rc5 no-sctp no-shared no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.32.1",
  perlargv => [ "no-shared", "--prefix=/usr", "--openssldir=/usr/lib/ssl", "--libdir=lib/x86_64-linux-gnu", "no-idea", "no-mdc2", "no-rc5", "no-zlib", "no-ssl3", "enable-unit-test", "no-ssl3-method", "enable-rfc3779", "enable-cms", "no-capieng", "enable-ec_nistp_64_gcc_128", "debian-amd64" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
  ...
  sdirs => [ "objects", "md4", "md5", "sha", "hmac", "ripemd", "whrlpool", "poly1305", "blake2", "siphash", "sm3", "des", "aes", "rc2", "rc4", "aria", "bf", "cast", "camellia", "seed", "sm4", "chacha", "modes", "bn", "ec", "rsa", "dsa", "dh", "sm2", "dso", "engine", "buffer", "bio", "stack", "lhash", "rand", "err", "evp", "asn1", "pem", "x509", "x509v3", "conf", "txt_db", "pkcs7", "pkcs12", "comp", "ocsp", "ui", "cms", "ts", "srp", "cmac", "ct", "async", "kdf", "store" ],
  shlib_major => "1",
  shlib_minor => "1",
...
our %target = (
  ...
  RANLIB => "ranlib",
  RC => "windres",
  _conf_fname_int => [ "../Configurations/00-base-templates.conf", "../Configurations/00-base-templates.conf", "../Configurations/10-main.conf", "../Configurations/10-main.conf", "../Configurations/00-base-templates.conf", "../Configurations/10-main.conf", "../Configurations/20-debian.conf", "../Configurations/20-debian.conf", "../Configurations/shared-info.pl" ],
  ...
  cast_obj => "c_enc.o",
  cflags => "-pthread -m64 -Wa,--noexecstack -Wall",
