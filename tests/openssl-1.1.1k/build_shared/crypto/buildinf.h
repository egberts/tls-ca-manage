...
#define PLATFORM "platform: debian-amd64"
#define DATE "built on: Tue Aug 24 08:28:12 2021 UTC"
...
static const char compiler_flags[] = {
    ...
    'O','0',' ','-','f','f','i','l','e','-','p','r','e','f','i','x',
    '-','m','a','p','=','/','h','o','m','e','/','w','o','l','f','e',
    '/','w','o','r','k','/','g','i','t','h','u','b','/','t','l','s',
    '-','c','a','-','m','a','n','a','g','e','/','t','e','s','t','s',
    '/','o','p','e','n','s','s','l','-','1','.','1','.','1','k','=',
    '.',' ','-','f','s','t','a','c','k','-','p','r','o','t','e','c',
