...
our %config = (
  ...
  openssl_api_defines => [  ],
  openssl_other_defines => [ "OPENSSL_RAND_SEED_OS", "OPENSSL_NO_ASAN", "OPENSSL_NO_CAPIENG", "OPENSSL_NO_CRYPTO_MDEBUG", "OPENSSL_NO_CRYPTO_MDEBUG_BACKTRACE", "OPENSSL_NO_DEVCRYPTOENG", "OPENSSL_NO_EGD", "OPENSSL_NO_EXTERNAL_TESTS", "OPENSSL_NO_FUZZ_AFL", "OPENSSL_NO_FUZZ_LIBFUZZER", "OPENSSL_NO_HEARTBEATS", "OPENSSL_NO_MSAN", "OPENSSL_NO_SCTP", "OPENSSL_NO_SSL_TRACE", "OPENSSL_NO_SSL3", "OPENSSL_NO_SSL3_METHOD", "OPENSSL_NO_UBSAN", "OPENSSL_NO_WEAK_SSL_CIPHERS", "OPENSSL_NO_STATIC_ENGINE" ],
  openssl_sys_defines => [  ],
  openssl_thread_defines => [ "OPENSSL_THREADS" ],
  openssldir => "/usr/lib/ssl",
  options => "enable-shared --prefix=/usr --openssldir=/usr/lib/ssl --libdir=lib/x86_64-linux-gnu enable-unit-test enable-rfc3779 enable-cms enable-ec_nistp_64_gcc_128 no-asan no-buildtest-c++ no-capieng no-crypto-mdebug no-crypto-mdebug-backtrace no-devcryptoeng no-egd no-external-tests no-fuzz-afl no-fuzz-libfuzzer no-heartbeats no-idea no-md2 no-mdc2 no-msan no-rc5 no-sctp no-ssl-trace no-ssl3 no-ssl3-method no-ubsan no-weak-ssl-ciphers no-zlib no-zlib-dynamic",
  perl_archname => "x86_64-linux-gnu-thread-multi",
  perl_cmd => "/usr/bin/perl",
  perl_version => "5.32.1",
  perlargv => [ "shared", "--prefix=/usr", "--openssldir=/usr/lib/ssl", "--libdir=lib/x86_64-linux-gnu", "no-idea", "no-mdc2", "no-rc5", "no-zlib", "no-ssl3", "enable-unit-test", "no-ssl3-method", "enable-rfc3779", "enable-cms", "no-capieng", "enable-ec_nistp_64_gcc_128", "debian-amd64" ],
  perlenv => {
      "AR" => undef,
      "ARFLAGS" => undef,
      "AS" => undef,
